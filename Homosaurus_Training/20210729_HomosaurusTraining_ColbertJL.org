# Copyright (C) 2022 Jay L. Colbert
...
#+reveal_title_slide: <h1>%t</h1><h2>%s</h2><h3>%a, %A</h3><p>Longy School of Music of Bard College</p><p>View online: <a href="%u">%u</a></p>
...
+ 2019: version 2
+ 2022: version 3.2. Where we are now!
...
#+reveal: split
Use /LGBTQ+ term/ as an umbrella term.
...
#+attr_reveal: :frag roll-in
Homosaurus has /Bears (Gay culture)/ and /Otters (Gay culture)/, but LoC has /Bears (Gay culture)/ with /Otters (Gay culture)/ as a *variant term*.
...
https://homosaurus.org/v3/homoit0000878
